        ...
        <div className="fixed inset-0 z-50 bg-neutral-800/60 flex items-center justify-center px-7 py-[10px]">
          <div className="relative bg-neutral-200 min-w-[320px] max-w-[519px] w-full rounded-md shadow-lg p-[25px] flex flex-col gap-6">
            ...
            <form onSubmit={handleSubmit} className="flex flex-col gap-6">
                ...
                <div className="space-y-1.5">
                  ...
                  <div className="relative">
                    <input
                      ...
                      required
                      className="text-black w-full px-3 py-2 border rounded-md outline outline-neutral-500 subtle"
                    />
                    <button
                      type="button"
                ...
                <div className="space-y-1.5">
                  ...
                  <div className="relative">
                    <input
                      ...
                      required
                      className="w-full px-3 py-2 border rounded-md outline outline-neutral-500 subtle text-black"
                    />
                    <button
                      type="button"
              ...
              {message && (
                <p className={status === 'error' ? 'text-red-500' : 'text-green-600 text-sm'}>
                  {message}
                </p>
              )}
