...
export default function ChangePassword() {
  ...
  return (
    <>
      ...
      {isModalOpen && (
        <Container>
          <div className='fixed inset-0 z-50 flex items-center justify-center bg-neutral-800/60 px-7 py-[10px]'>
            <div className='relative flex w-full max-w-[519px] min-w-[320px] flex-col gap-6 rounded-md bg-neutral-200 p-[25px] shadow-lg'>
              ...
              <form onSubmit={handleSubmit} className='flex flex-col gap-6'>
                <div className='flex flex-col gap-4'>
                  ...
                  <div className='space-y-1.5'>
                    <label
                      ...
                      className='medium block text-black'
                    >
                      Current Password
                    </label>
                ...
                <button
                  type='submit'
                  className='bg-primary-900 small hover:bg-primary-700 ml-auto w-[151px] rounded-md px-4 py-2'
                  disabled={isLoading}
                >
