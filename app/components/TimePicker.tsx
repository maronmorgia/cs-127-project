    ...
    <fieldset className='flex flex-col gap-1'>
      ...
      <div className='flex items-center gap-3'>
        ...
        <input
          ...
          className='medium w-14 rounded-lg border border-neutral-400 p-2 text-center text-neutral-900 focus:outline-none'
        />
        ...
        <select
          ...
          className='medium rounded-lg border border-neutral-400 p-2.5 text-neutral-900 focus:outline-none'
        >
